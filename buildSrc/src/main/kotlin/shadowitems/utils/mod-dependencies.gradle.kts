...
abstract class ShadowitemsModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<ShadowitemsModDependenciesExtension>("shadowitemsModDependencies")
