...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/shadowitems.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: shadowitems-common-common-refmap.json
        // fixed:   shadowitems-common.refmap.json
